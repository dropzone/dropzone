...
I just released Dropzone 5.0.0, which includes *browser side image resizing*. This means that you can resize the
images on the client, before sending them to the server, saving upload bandwidth and reducing upload time.

Big shout out to MD Systems, who donated the money to make this feature available for everybody!
