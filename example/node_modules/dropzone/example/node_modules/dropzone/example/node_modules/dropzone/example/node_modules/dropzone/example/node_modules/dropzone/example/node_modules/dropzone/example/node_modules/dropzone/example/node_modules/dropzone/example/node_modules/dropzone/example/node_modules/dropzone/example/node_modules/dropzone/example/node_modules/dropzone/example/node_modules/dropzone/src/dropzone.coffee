...
# Those functions have been cherry picked out of underscore
...
without = (list, withoutList...) ->
  val for val in withoutList when not _.include withoutList, val
