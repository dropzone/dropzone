...
(function () {
  ...
  (function() {
    var $, Dropzone, bean, include, nativeIndexOf, noOp, without,
      __slice = [].slice,
    ...
    without = function() {
      var list, val, withoutList, _i, _len, _results;
      list = arguments[0], withoutList = 2 <= arguments.length ? __slice.call(arguments, 1) : [];
      _results = [];
      for (_i = 0, _len = withoutList.length; _i < _len; _i++) {
        val = withoutList[_i];
        if (!_.include(withoutList, val)) {
          _results.push(val);
        }
      }
      return _results;
